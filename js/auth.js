...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Sélecteurs pour le mot de passe oublié
    ...
    forgotPasswordForm?.addEventListener('submit', async (e) => {
        ...
        try {
            // Rediriger vers Discord pour le support
            window.location.href = 'https://discord.gg/Wk28VF68s7';
            
            // Afficher un message avant la redirection
            const successMessage = document.createElement('p');
            successMessage.className = 'success-message';
            successMessage.textContent = 'Vous allez être redirigé vers notre support Discord...';
...
function updateUIForLoggedUser(user) {
    ...
    // Supprimer les anciens boutons de connexion/inscription s'ils existent
    const authButtons = document.querySelectorAll('.nav-btn');
